...
import { StakeAuthorization } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { StakeAuthorization_Validators } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { LastValidatorPower } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { HistoricalInfo } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { CommissionRates } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Commission } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Description } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Validator } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { ValAddresses } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { DVPair } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { DVPairs } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplet } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplets } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Delegation } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegation } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegationEntry } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntry } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Redelegation } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Params } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { DelegationResponse } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntryResponse } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationResponse } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
import { Pool } from "m-example-chain-client-ts/cosmos.staking.v1beta1/types"
