...
import MexamplechainMexamplemodule from './mexamplechain.mexamplemodule'
...
export default { 
  MexamplechainMexamplemodule: load(MexamplechainMexamplemodule, 'mexamplechain.mexamplemodule'),
