...
import (
	...
	mexamplemodulesimulation "m-example-chain/x/mexamplemodule/simulation"
...
var (
	_ = sample.AccAddress
	_ = mexamplemodulesimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	mexamplemoduleGenesis := types.GenesisState{
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&mexamplemoduleGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		mexamplemodulesimulation.SimulateMsgCreateEntityName(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		mexamplemodulesimulation.SimulateMsgUpdateEntityName(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		mexamplemodulesimulation.SimulateMsgDeleteEntityName(am.accountKeeper, am.bankKeeper, am.keeper),
	))
