...
function createBaseEntityName(): EntityName {
  return { id: 0, field1: "", field2: 0, creator: "" };
}

export const EntityName = {
  encode(message: EntityName, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EntityName {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEntityName();
  ...
  fromJSON(object: any): EntityName {
    return {
  ...
  toJSON(message: EntityName): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<EntityName>, I>>(object: I): EntityName {
    const message = createBaseEntityName();
