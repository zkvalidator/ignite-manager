...
import { WeightedVoteOption } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "m-example-chain-client-ts/cosmos.gov.v1beta1/types"
