...
import { GenericAuthorization } from "m-example-chain-client-ts/cosmos.authz.v1beta1/types"
import { Grant } from "m-example-chain-client-ts/cosmos.authz.v1beta1/types"
import { GrantAuthorization } from "m-example-chain-client-ts/cosmos.authz.v1beta1/types"
import { GrantQueueItem } from "m-example-chain-client-ts/cosmos.authz.v1beta1/types"
import { EventGrant } from "m-example-chain-client-ts/cosmos.authz.v1beta1/types"
import { EventRevoke } from "m-example-chain-client-ts/cosmos.authz.v1beta1/types"
